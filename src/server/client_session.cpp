...
ClientSession::ClientSession(int _conn_fd) : conn_fd_(_conn_fd)
{
}

void ClientSession::Launch()
{
  ...
  if (send(conn_fd_, server_pubkey.c_str(), strlen(server_pubkey.c_str()), 0) < 0)
  {
